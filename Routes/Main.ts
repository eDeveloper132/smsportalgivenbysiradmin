...
router.get("/toapprove", (req: Request, res: Response) => {
    res.sendFile(path.resolve(__dirname, "../Views/approvetag.html"));
});

router.get('/approvedata', async (req: Request, res: Response) => {
...
router.post('/getapproved', async (req: Request, res: Response) => {
