...
router.get("/usersdata", async (req: Request, res: Response) => {
  ...
  try {
    const response = await axios.post(
      "https://ap-southeast-1.aws.data.mongodb-api.com/app/data-mdipydh/endpoint/data/v1/action/find",
      data,
      {
        headers: {
          "Content-Type": "application/json",
...
router.put(
  ...
  async (req: Request, res: Response) => {
    ...
    const REPLACE_URL =
      "https://ap-southeast-1.aws.data.mongodb-api.com/app/data-mdipydh/endpoint/data/v1/action/replaceOne";
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      const deleteResponse = await axios.post(
        "https://ap-southeast-1.aws.data.mongodb-api.com/app/data-mdipydh/endpoint/data/v1/action/deleteOne",
        {
          dataSource: "SMSCluster",
          database: "test",
          collection: "signhandlers",
...
router.post("/user/adduser", async (req: Request, res: Response) => {
  ...
  const { Name, Email, Password, Role, Organization, Phone, CountryCode } =
    req.body;
...
router.post("/user/changepass", async (req: Request, res: AppRes) => {
